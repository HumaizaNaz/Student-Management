...
const randomNumber: number = Math.floor(10000 + Math.random() * 90000); //lets remove points value
...
let paymentType = await inquirer.prompt([{
    ...
    validate:function(value){//if someone not enter tha amount its print "please enter a valid value"
        if(value.trim() !== ""){
            return true
        }
